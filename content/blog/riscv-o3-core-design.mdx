---
title: 'Building a RISC-V Out-of-Order Core: Pipeline Design, Branch Prediction, and Memory Ordering'
description: 'A hands-on guide to designing an out-of-order RISC-V processor core, from the frontend fetch stage through the issue queue to the load-store unit and ROB commit.'
date: '2024-08-22'
tags: ['RISC-V', 'SystemVerilog', 'Computer Architecture', 'Processor Design']
